...
>
  ...
  <!-- Bottom Details -->
  <div class="absolute bottom-0 left-0 right-0 flex flex-col gap-2 p-4 text-white"> 
    <div>
    ...
    <div class="flex items-center justify-between gap-2">
      <div>
        <span class="line-through text-sm text-gray-300">₱{deal.original_price}</span>
        <span class="text-2xl font-extrabold text-[#f76800]">₱{deal.discount_price}</span>
      </div> 
      <p class="w-fit h-fit rounded-lg bg-[#f76800] px-2 py-0.5 text-xs font-bold">
