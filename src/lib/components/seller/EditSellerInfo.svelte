    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3 lg:gap-12">
      ...
      <div class="lg:col-span-1">
        <div class="space-y-3 lg:sticky lg:top-6">
          <label for="" class="block text-sm font-semibold text-gray-700 lg:text-base">Store Logo</label>
          <label
            class="flex min-h-[18vh] cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 p-6 text-center transition hover:border-blue-400 hover:bg-blue-50 lg:min-h-[25vh] lg:p-8 {imagePreviews.length >= 1 ? 'cursor-not-allowed opacity-50' : ''}"
          >
            ...
            <span class="mt-2 italic text-xs text-gray-600 lg:text-sm">
          ...
          {#if imagePreviews.length > 0}
            <div class="flex justify-center pt-2">
              <div class="group relative aspect-square w-32 flex-shrink-0 overflow-hidden rounded-lg border border-gray-200 shadow-sm lg:w-40">
                <img
                  src={imagePreviews[0]}
                  alt="Store logo"
                ...
                <div class="absolute bottom-2 left-2 rounded px-2 py-1 text-xs text-white lg:text-sm {hasNewImage ? 'bg-green-600' : 'bg-blue-600'}">
          ...
          <div class="space-y-6 lg:space-y-8">
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-8">
              ...
              <div class="space-y-2 lg:space-y-3">
                <label for="" class="block text-sm font-medium text-gray-700 lg:text-base">Store Name</label>
                <input
                  type="text"
              ...
              <!-- Contact Number -->
              <div class="space-y-2 lg:space-y-3">
                <label for="" class="block text-sm font-medium text-gray-700 lg:text-base">Contact Number</label>
                <div class="flex rounded-xl border-2 border-gray-300 bg-white focus-within:border-gray-900">
            ...
            <!-- Address (Full Width) -->
            <div class="space-y-2 lg:space-y-3">
              <label for="" class="block text-sm font-medium text-gray-700 lg:text-base">Address</label>
              <textarea
                bind:value={address}
                placeholder="Enter your store address"
                rows="3"
                class="w-full resize-none rounded-xl border-2 border-gray-300 bg-white px-4 py-3 text-gray-900 placeholder-gray-400 transition-colors focus:border-gray-900 focus:outline-none lg:px-5 lg:py-4 lg:text-lg lg:rows-4"
              ></textarea>
            </div>
          </div>
        ...
        <div class="space-y-4">
          ...
          <div class="flex items-center justify-between rounded-xl bg-gray-50 p-4">
            ...
            <button
              ...
              class="relative inline-flex h-6 w-11 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none {pickup ? 'bg-[#0060a9]' : 'bg-gray-300'}"
              role="switch"
              aria-checked={pickup}
              aria-label="pickup"
            >
              <span class="pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow-lg transition duration-200 ease-in-out {pickup ? 'translate-x-5' : 'translate-x-0'}"></span>
            </button>
          </div>
          ...
          <div class="flex items-center justify-between rounded-xl bg-gray-50 p-4">
            ...
            <button
              ...
              class="relative inline-flex h-6 w-11 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none {delivery ? 'bg-[#0060a9]' : 'bg-gray-300'}"
              role="switch"
              aria-checked={delivery}
              aria-label="delivery"
            >
              <span class="pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow-lg transition duration-200 ease-in-out {delivery ? 'translate-x-5' : 'translate-x-0'}"></span>
            </button>
          </div>
        </div>
