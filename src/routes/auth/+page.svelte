	...
	<div class="w-full max-w-md space-y-6">
		...
		>
			...
			<div class="space-y-3">
				<button
					type="button"
					on:click={signIn('google', { callbackUrl: '/lastSignOn' })}
			...
			<!-- <div class="relative">
				...
				<div class="relative flex justify-center text-sm">
					<span class="bg-gray-100 px-2 text-gray-500">or continue with email</span>
				</div>
			</div>
			...
			<div class="flex items-center justify-between">
				<div class="flex items-center">
					<input
						...
						name="remember-me"
						type="checkbox"
						class="h-4 w-4 cursor-pointer rounded border-gray-300 text-orange-500 transition-colors duration-200 hover:border-gray-400 focus:ring-orange-500"
					/>
					<label
						for="remember-me"
						class="ml-2 block cursor-pointer text-sm text-gray-700 transition-colors duration-200 hover:text-gray-900"
					>
						Remember Me
					</label>
				</div> -->
